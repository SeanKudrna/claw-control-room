...
try {
  ...
  await desktop.locator('[data-map-control="zoom-in"]').click({ force: true });
  await desktop.waitForFunction(
    () => Number.parseFloat(document.querySelector('.skills-tree-map')?.getAttribute('data-map-zoom') ?? '1') > 1.05,
  );

  await desktop.screenshot({
    path: 'status/ui-validation/issue49-skills-desktop-controls-zoomed.png',
    fullPage: true,
  });
  ...
  await desktop.screenshot({
    path: 'status/ui-validation/issue49-skills-desktop-fit-view.png',
    fullPage: true,
  });
  ...
  await desktop.screenshot({
    path: 'status/ui-validation/issue49-skills-desktop-modal.png',
    fullPage: true,
  });
  ...
  await mobile.locator('[data-map-control="zoom-in"]').click({ force: true });
  await mobile.waitForFunction(
    () => Number.parseFloat(document.querySelector('.skills-tree-map')?.getAttribute('data-map-zoom') ?? '1') > 1.05,
  );

  await mobile.screenshot({
    path: 'status/ui-validation/issue49-skills-mobile-controls-zoomed.png',
    fullPage: true,
  });
  ...
  await mobile.screenshot({
    path: 'status/ui-validation/issue49-skills-mobile-fit-view.png',
    fullPage: true,
  });
  ...
  await mobile.screenshot({
    path: 'status/ui-validation/issue49-skills-mobile-modal.png',
    fullPage: true,
  });
} finally {
  await desktop.close();
