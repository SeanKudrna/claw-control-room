...
try {
  ...
  await desktop.screenshot({
    path: 'status/ui-validation/issue46-skills-desktop-tree.png',
    fullPage: true,
  });
  ...
  await desktop.screenshot({
    path: 'status/ui-validation/issue46-skills-desktop-modal.png',
    fullPage: true,
  });
  ...
  await mobile.screenshot({
    path: 'status/ui-validation/issue46-skills-mobile-tree.png',
    fullPage: true,
  });
  ...
  await mobile.screenshot({
    path: 'status/ui-validation/issue46-skills-mobile-modal.png',
    fullPage: true,
  });
} finally {
  await desktop.close();
